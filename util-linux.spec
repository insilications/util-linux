...
Source0  : https://www.kernel.org/pub/linux/utils/util-linux/v2.29/util-linux-2.29.1.tar.xz
...
%prep
%setup -q -n util-linux-2.29.1
%patch1 -p1
%patch2 -p1
%patch3 -p1
%patch4 -p1
pushd ..
cp -a util-linux-2.29.1 build32
popd

%build
export LANG=C
export SOURCE_DATE_EPOCH=1485881610
